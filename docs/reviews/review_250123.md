...
- Returning from an actor entry function = `HIVE_EXIT_REASON_NORMAL` (Erlang semantics, updated Jan 2026)
...
This makes intent explicit - returning is normal completion, crashes require explicit signaling.
