...
// hive_timer_id_t is defined in hive_types.h

#define HIVE_TIMER_ID_INVALID ((hive_timer_id_t)0)
...
// Timer message: class=HIVE_MSG_TIMER, tag=hive_timer_id_t, no payload
// Use hive_msg_is_timer() to check, msg.tag for hive_timer_id_t
